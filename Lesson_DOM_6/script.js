...
const productsData = [];
url1.products.forEach((elem) => {
   productsData.push(elem);
})

const productBox = document.querySelector('.product__content');
...
productsData.forEach(productData => {
   ...
   productImage.src = './images/' + productData.productImage;
   ...
   productTitleLink.href = '.product.html';
